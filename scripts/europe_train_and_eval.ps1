...
$SAVE      = "C:\Users\ylchen\workspace\research_group\artifacts\finetune_checkpoints\run_europe_20260601"
$TRAIN_DIR = "C:\Users\ylchen\workspace\timesfm_finetuning\finetune_europe\data\train_v2"
$EVAL_DIR  = "C:\Users\ylchen\workspace\timesfm_finetuning\finetune_europe\data\eval"

Write-Host "===== EUROPE RETRAIN START ====="
...
Write-Host "`n===== EUROPE EVAL START ====="
...
Write-Host "`n===== EUROPE TRAIN+EVAL COMPLETE ====="
