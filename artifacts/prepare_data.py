...
if __name__ == "__main__":
    ...
    output_directory = r"C:\Users\ylchen\workspace\research_group\artifacts\focused_ticker_data"
    save_tickers_to_npy(focused_tickers, output_directory)
